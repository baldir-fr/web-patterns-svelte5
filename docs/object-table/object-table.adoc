...
Example in link:{examplesdir}/object-table/src/lib/ObjectTable.svelte[object-table/src/lib/ObjectTable.svelte]
...
link:{examplesdir}/object-table/src/lib/object-table.css[object-table/src/lib/object-table.css]
...
And imported in the link:{examplesdir}/object-table/src/routes/+page.svelte[object-table/src/routes/+page.svelte]
